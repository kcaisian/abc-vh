...
// ── BODY PARTS DATA ───────────────────────────────────────────────────────────
const BODY_PARTS = [
  { id:"wrist",    name:"Wrist & Forearm", desc:"Flexibility, strength and rotation",                 tag:"upper limb" },
  { id:"elbow",    name:"Elbow",           desc:"Bends, extensions, resistance",                      tag:"upper limb" },
  { id:"shoulder", name:"Shoulder",        desc:"Very common after strokes & sports injuries",        tag:"upper limb" },
  { id:"neck",     name:"Neck",            desc:"Chin tucks, rotations, stretches",                   tag:"posture"    },
  { id:"hips",     name:"Hips",            desc:"Clamshells, bridges, hip flexor stretches",          tag:"lower limb" },
  { id:"knee",     name:"Knee",            desc:"Common after ACL injuries or surgeries",             tag:"lower limb" },
  { id:"legs",     name:"Legs (General)",  desc:"Sit-to-stands, lunges, walking practice",            tag:"lower limb" },
  { id:"full",     name:"Full Body",       desc:"Chair exercises, Tai Chi, range-of-motion routines", tag:"functional" },
]

// ── EXERCISE DATA ─────────────────────────────────────────────────────────────
const EXERCISES_BY_PART = {
  shoulder: [
  { id:"arm_raise",     name:"Assisted Arm Raises", tag:"reps",    target:10, holdTarget:null, type:"rep",
  ...
  { id:"chest_stretch", name:"Chest Stretch Hold",  tag:"hold·5s", target:5,  holdTarget:5,    type:"hold",
  ...
  { id:"arm_circles",   name:"Arm Circles",         tag:"reps",    target:12, holdTarget:null, type:"rep",
  ...
  elbow: [
  { id:"bicep_curl", name:"Bicep Curls", tag:"reps", target:12, holdTarget:null, type:"rep",
  ...
  { id:"pushup", name:"Push-Ups", tag:"reps", target:10, holdTarget:null, type:"rep",
  ...
  wrist: [
  { id:"wrist_flex", name:"Wrist Flexion Stretch", tag:"hold·5s", target:6,  holdTarget:5,    type:"hold",
  ...
  { id:"wrist_curl", name:"Wrist Curls",           tag:"reps",    target:15, holdTarget:null, type:"rep",
  ...
  knee: [
  { id:"squat",      name:"Sit-to-Stand", tag:"reps", target:10, holdTarget:null, type:"rep",
  ...
  { id:"knee_raise", name:"Knee Raises",  tag:"reps", target:10, holdTarget:null, type:"rep",
  ...
  legs: [
  { id:"squat2",      name:"Assisted Squat", tag:"reps", target:10, holdTarget:null, type:"rep",
  ...
  { id:"knee_raise2", name:"Leg Raises",     tag:"reps", target:12, holdTarget:null, type:"rep",
...
for (const p of BODY_PARTS) {
  ...
  btn.dataset.id = p.id
  // Omit the icon element entirely (icons removed)
  btn.innerHTML = `<div class="pname">${p.name}</div><div class="pdesc">${p.desc}</div><span class="ptag">${p.tag}</span>`
